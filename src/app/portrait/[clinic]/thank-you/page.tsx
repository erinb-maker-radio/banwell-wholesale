  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16 text-center">
      ...
      <p className="text-lg text-gray-500 leading-relaxed mb-8">
        You will receive an email from us within one business day asking for your pet&apos;s photo.
        Once we have it, we will design your portrait and send you a proof to approve before
        anything is printed.
      </p>
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-xl p-6 text-left mb-8">
        ...
        <ol className="space-y-2 text-sm text-gray-600">
          <li><span className="font-medium text-gray-800">1.</span> We email you to collect your favorite photo of your pet.</li>
