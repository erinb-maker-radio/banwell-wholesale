...
const category = glassData.categories.find((c) => c.slug === 'sun-catchers')!;

export const metadata = {
  title: 'Sun Catchers - Stained Glass - Banwell Designs',
  description: category.description,
};

export default function SunCatchersPage() {
  return (
