...
function AccountHeader() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:pl-8 lg:pr-[336px]">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link href="/account/cart" className="text-gray-600 hover:text-gray-900 lg:hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:pl-8 lg:pr-[336px] py-8">
  ...
  return (
    <div style={{ color: '#111827' }} className="bg-gray-50 min-h-screen">
      <AuthProvider>
        <CartProvider>
          <AccountHeader />
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:pl-8 lg:pr-[336px] -mt-8">
            {children}
          </div>
          <CartSidebar />
        </CartProvider>
